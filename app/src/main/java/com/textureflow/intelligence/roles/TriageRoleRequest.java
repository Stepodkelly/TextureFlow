...
/** One A3/A4 triage call. Prompt user-message is the shielded JSON only. */
public final class TriageRoleRequest {
    ...
    public TriageRoleRequest(ShieldedContext context, PriorityResult deterministic) {
        this(context, deterministic, "ACTIVE", 1, 1, null);
    }

    public TriageRoleRequest(
